...
ComfortableMexicanSofa.configure do |config|
  ...
  config.cms_title = 'Personalize me!'
  ...
  # but if you really want to allow it...
...
module ComfyAdminAuthentication
  def authenticate
    redirect_to [:new, :admin_session] unless current_admin
  end
end
...
module ComfyAdminAuthorization
  def authorize
    ...
    # 
    redirect_to polymorphic_path([:admin, :root]), alert: t('flash.unpermitted') unless current_admin.permitted_to?(params)
    # 
  end
end
