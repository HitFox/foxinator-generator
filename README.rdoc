...
<tt>gem 'comfortable_mexican_sofa', git: 'git@github.com:HitFox/comfortable-mexican-sofa.git'
gem "foxinator-generator", git: "git@github.com:HitFox/foxinator-generator.git"</tt>
