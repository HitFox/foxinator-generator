...
ActiveRecord::Schema.define(version: 20150511093227) do
  ...
  add_index "admins", ["state"], name: "index_admins_on_state"

  create_table "admins_comments", id: false, force: :cascade do |t|
    t.integer "admin_id",   null: false
    t.integer "comment_id", null: false
  end

  add_index "admins_comments", ["admin_id", "comment_id"], name: "index_admins_comments_on_admin_id_and_comment_id"
  add_index "admins_comments", ["comment_id", "admin_id"], name: "index_admins_comments_on_comment_id_and_admin_id"
  ...
  add_index "admins_permissions", ["admin_id", "permission_id"], name: "index_admins_permissions_on_admin_id_and_permission_id"
  add_index "admins_permissions", ["permission_id", "admin_id"], name: "index_admins_permissions_on_permission_id_and_admin_id"
